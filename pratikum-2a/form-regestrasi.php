...
<head>
    ...
    <title>From Register IT Club Data Science</title>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124014" type="text" class="form-control" required="required">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Qois " type="text" class="form-control" required="required">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <select id="prodi" name="prodi" required="required" class="custom-select">
        ...
        echo "caption value = '$kode'>$nama</option>";
        }
        ?>
      </select>
    </div>
