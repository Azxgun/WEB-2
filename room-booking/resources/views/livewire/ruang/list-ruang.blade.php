            ...
            <tbody>
                @foreach ($ruangs as $index => $ruang)
                    <tr class="{{ $index % 2 === 0 ? 'bg-gray-900' : 'bg-gray-800' }} text-white">
                        <td class="py-2 px-4 border border-gray-700">{{ $ruang->id }}</td>
                        <td class="py-2 px-4 border border-gray-700">{{ $ruang->kode }}</td>
                        <td class="py-2 px-4 border border-gray-700">{{ $ruang->nama }}</td>
                        <td class="py-2 px-4 border border-gray-700">{{ $ruang->status }}</td>
